    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-3xl mx-auto">
        ...
        <div
          ...
          style={{ fontFamily: "var(--font-body)" }}
        >
          <p className="text-lg sm:text-xl text-primary/80 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] uppercase tracking-[0.15em]">
        ...
        <Link
          ...
          target="_blank"
          className="inline-block px-10 py-4 bg-primary text-black text-sm font-bold uppercase tracking-[0.15em] rounded hover:bg-accent/80 hover:scale-105 transition-all duration-300 shadow-lg shadow-black/30"
          style={{ fontFamily: "var(--font-body)" }}
        >
          RSVP Now
        </Link>
