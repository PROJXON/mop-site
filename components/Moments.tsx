  ...
  return (
    <section className="moments">
      ...
      <div className="video-highlights mb-5 flex gap-5 items-center justify-center">
        {/* 
        |
        | Try to include buttons to change the video and show different highlights, or maybe a carousel of videos that auto-scrolls through the highlights.
        |
        */}
      ...
      <AutoScrollCarousel itemCount={7}>
        <PictureCard
