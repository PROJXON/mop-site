...
const MopAudienceMix: React.FC = () => {
  return (
    <section className="bg-black/10 p-2 animate-fadeIn" id="audience">
      <div className="max-w-5xl mx-auto flex flex-col gap-2 py-16 px-4 md:px-5 lg:max-w-10/12">
        <div>
          <p
          ...
          >
            A room full of
            <br />
            <em className="text-[var(--color-secondary)]/50">decision-makers.</em>
          </h2>
          <p className="text-lg">
